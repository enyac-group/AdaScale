...
import mxnet as mx
from function.test_rcnn import test_scalereg # a big function testing rcnn
...
def main():
    ...
    test_scalereg(config, config.dataset.dataset, config.dataset.test_image_set, config.dataset.root_path, config.dataset.dataset_path,
