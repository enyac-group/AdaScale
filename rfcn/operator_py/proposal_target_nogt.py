...
class ProposalTargetNoGTOperator(mx.operator.CustomOp):
    def __init__(self, num_classes, batch_images, batch_rois, cfg, fg_fraction):
        super(ProposalTargetNoGTOperator, self).__init__()
...
@mx.operator.register('proposal_target_nogt')
class ProposalTargetNoGTProp(mx.operator.CustomOpProp):
    def __init__(self, num_classes, batch_images, batch_rois, cfg, fg_fraction='0.25'):
        super(ProposalTargetNoGTProp, self).__init__(need_top_grad=False)
    ...
    def create_operator(self, ctx, shapes, dtypes):
        return ProposalTargetNoGTOperator(self._num_classes, self._batch_images, self._batch_rois, self._cfg, self._fg_fraction)
